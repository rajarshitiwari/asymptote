		...
		if ((i1+i2) % 2 == 0)
		  {
		    ...
		    //draw(vec1..vec2,rgb(0.9,0.1,0.1)+thick3,Arrow3(30));

		    draw((i1,i2,i3)..(i1+j1,i2,i3),blue+thick1);
		    draw((i1,i2,i3)..(i1,i2+j2,i3),blue+thick1);
		    draw((i1,i2,i3)..(i1,i2,i3+j3),blue+thick1);
		    draw((i1,i2,i3)..(i1-k1,i2,i3),blue+thick1);
		    draw((i1,i2,i3)..(i1,i2-k2,i3),blue+thick1);
		    draw((i1,i2,i3)..(i1,i2,i3-k3),blue+thick1);
		  }else
		  {
		    ...
		    draw((i1,i2,i3)..(i1+j1,i2,i3),red+thick1);
		    draw((i1,i2,i3)..(i1,i2+j2,i3),red+thick1);
		    draw((i1,i2,i3)..(i1,i2,i3+j3),red+thick1);
		    draw((i1,i2,i3)..(i1-k1,i2,i3),red+thick1);
		    draw((i1,i2,i3)..(i1,i2-k2,i3),red+thick1);
		    draw((i1,i2,i3)..(i1,i2,i3-k3),red+thick1);
		  }
	      }
	  }
      }
