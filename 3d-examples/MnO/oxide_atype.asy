...
n=5;
currentprojection=perspective(10,10.5,n/2+0.5,center=true);
  ...
  {if (i1 == n) {j1 = 0;}else
	...
	for (int i3 = 0; i3 <= n; ++i3)
	  {if (i3 == n) {j3 = 0;}else
	      {j3 = 1;}
	    if((i1+i2+i3)%2 ==1)
	      {	draw(shift((i1,i2,i3))*O,rgb(0.,0.8,0.2)+linewidth(3.0));}
	    else
	      {	draw(shift((i1,i2,i3))*Ni,rgb(0.,0.6,1.0)+linewidth(3.0));
...
draw("O$_1$",(n,0,0),rgb(0.8,0.0,0.0)+fontsize(36));
draw("O$_2$",(-0.4,n+0.4,0),rgb(0.8,0.0,0.0)+fontsize(36));
draw("O$_3$",(n-0.1,n+0.4,n),rgb(0.8,0.0,0.0)+fontsize(36));
draw("O$_4$",(-0.4,0.4,0),rgb(0.8,0.0,0.0)+fontsize(48));
