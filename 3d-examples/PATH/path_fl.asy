	...
	for (int i3 = 0; i3 <= n; ++i3)
	  {
		...
		draw(shift((i1,i2,i3))*Mo,green+linewidth(7.0));
	      ...
	      {
		vec = ((-1)^(i2+i3),(-1)^(i3+i1),(-1)^(i1+i2));
		if (vec == (-1,-1,1))
		  {
		    draw(shift((i1,i2,i3))*Fe,blue+linewidth(4.0));
		    vec = 1.0*vec/sqrt(3.0);
		...
		if (vec == (1,1,1))
		  {
		    draw(shift((i1,i2,i3))*Fe,cyan+linewidth(4.0));
		    vec = 1.0*vec/sqrt(3.0);
		    vec1 = (i1,i2,i3)-0.3*vec;
		    vec2 = (i1,i2,i3)+0.5*vec;
		    draw((i1,i2,i3)..(i1+j1,i2,i3),cyan+thick1,lit);draw((i1,i2,i3)..(i1,i2+j2,i3),cyan+thick1,lit);
		    draw((i1,i2,i3)..(i1,i2,i3+j3),cyan+thick1,lit);draw((i1,i2,i3)..(i1-k1,i2,i3),cyan+thick1,lit);
		    draw((i1,i2,i3)..(i1,i2-k2,i3),cyan+thick1,lit);draw((i1,i2,i3)..(i1,i2,i3-k3),cyan+thick1,lit);
		  }
		if (vec == (-1,1,-1))
		  {
		...
		if (vec == (1,-1,-1))
		  {
		    draw(shift((i1,i2,i3))*Fe,magenta+linewidth(4.0));
		    vec = 1.0*vec/sqrt(3.0);
		    vec1 = (i1,i2,i3)-0.3*vec;
		    vec2 = (i1,i2,i3)+0.5*vec;
		    draw((i1,i2,i3)..(i1+j1,i2,i3),magenta+thick1,lit);draw((i1,i2,i3)..(i1,i2+j2,i3),magenta+thick1,lit);
		    draw((i1,i2,i3)..(i1,i2,i3+j3),magenta+thick1,lit);draw((i1,i2,i3)..(i1-k1,i2,i3),magenta+thick1,lit);
		    draw((i1,i2,i3)..(i1,i2-k2,i3),magenta+thick1,lit);draw((i1,i2,i3)..(i1,i2,i3-k3),magenta+thick1,lit);
		  }
