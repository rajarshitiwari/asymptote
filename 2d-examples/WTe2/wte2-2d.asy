...
for (i1 = 0; i1 <= num1; ++i1)
  {if (i1 == num1){j1 = 0;}else{j1 = 1;}
	...
	// Te-Te bonds
	draw_bond(x+w1+te1--x+w1+te1+a2,3);
	draw_bond(x+w1+te2--x+w1+te2+a2,3);
	draw_bond(x+w1+te3--x+w1+te4,3);
	draw_bond(x+w1+te5--x+w1+te6,3);
	draw_bond(x+w1+te2--x+w1+te5,3);
	draw_bond(x+w1+te2--x+w1+te6,3);
	draw_bond(x+w1+te2--x+w1+te3,3);
	draw_bond(x+w1+te2--x+w1+te4,3);
	draw_bond(x+w1+te1--x+w1+te5+a1,3);
	draw_bond(x+w1+te1--x+w1+te6+a1,3);
